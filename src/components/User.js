const people = [
  ...
  },
  {
    name: "Imie Nazwisko",
    role: "Doktor",
    imageUrl: "https://tcm-kongres.pl/img/speakers/ricardo_bw.jpg",
    bio: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
  },
  {
    name: "Imie Nazwisko",
  ...
  },
  {
    name: "Imie Nazwisko",
    role: "Doktor",
    imageUrl: "https://tcm-kongres.pl/img/speakers/tomasz_43_640_480.jpg",
    twitterUrl: "#",
    linkedinUrl: "#",
    bio: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
  },
  {
    name: "Imie Nazwisko",
    role: "Doktor",
    imageUrl: "https://tcm-kongres.pl/img/speakers/zhou_43_640_480.jpg",
    twitterUrl: "#",
    linkedinUrl: "#",
    bio: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
  },
  {
    name: "Imie Nazwisko",
    role: "Doktor",
    imageUrl: "https://tcm-kongres.pl/img/speakers/dorota_43_640_480.jpg",
    twitterUrl: "#",
    linkedinUrl: "#",
    bio: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
  },
...
//       </h2>
//       <p className="mt-6 text-lg leading-8 text-gray-600">
//         Poznajcie naszych wykladowcow. Jest to zespol swiatowej swiaty
//         specjalistow. Kazdy z nich ma wieloletnie doswiadczneie w tym co
//         robi.
//       </p>
//     </div>
//     <ul
...
//               {person.name}
//             </h3>
//             <p className="text-base leading-7 text-gray-600">{person.bio}</p>
